...
urlpatterns = [
    ...
    path('ramadan/payment/initialize/', initialize_lahza_payment, name='ramadan_payment_initialize'),
    path('ramadan/payment/verify/', verify_lahza_payment, name='ramadan_payment_verify'),
