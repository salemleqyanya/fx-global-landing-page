...
from .views import landing_page, elite_program, black_friday, lahza_checkout, initialize_lahza_payment, verify_lahza_payment, test_email, privacy_policy, terms_of_service, get_black_friday_end_date
